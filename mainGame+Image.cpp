...
void mainGame::imagesInit()
{
	...
	IMAGEMANAGER->addFrameImage("¹Ì³ëÅ¸¿ì·Î½º", "images/monster/Minotaurs.bmp",450*3, 100*3,9,2, true, RGB(255, 0, 255));
	IMAGEMANAGER->addFrameImage("·¹µåµå·¡°ï", "images/monster/µå·¡°ï.bmp",549*3, 106*3,9,2, true, RGB(255, 0, 255));
	...
	EFFECTMANAGER->addEffect("µå·¡°ïºê·¹½º1L", "images/effect/µå·¡°ïºê·¹½º1L.bmp",168*2,24*2,24*2,24*2, 1, 0.1f, 100);
	EFFECTMANAGER->addEffect("µå·¡°ïºê·¹½º1R", "images/effect/µå·¡°ïºê·¹½º1R.bmp",168*2,24*2,24*2,24*2, 1, 0.1f, 100);
	EFFECTMANAGER->addEffect("µå·¡°ïºê·¹½º2", "images/effect/µå·¡°ïºê·¹½º2.bmp",168*2,24*2,24*2,24*2, 1, 0.1f, 100);
	EFFECTMANAGER->addEffect("µå·¡°ïºê·¹½º3", "images/effect/µå·¡°ïºê·¹½º3.bmp",168*2,24*2,24*2,24*2, 1, 0.1f, 100);
	EFFECTMANAGER->addEffect("µå·¡°ïºê·¹½º4", "images/effect/µå·¡°ïºê·¹½º4.bmp",168*2,24*2,24*2,24*2, 1, 0.1f, 100);
	EFFECTMANAGER->addEffect("µå·¡°ïºê·¹½º5", "images/effect/µå·¡°ïºê·¹½º5.bmp",168*2,24*2,24*2,24*2, 1, 0.1f, 100);
