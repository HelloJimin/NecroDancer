...
void player::effectControl(attackForm form, int rengeArrNum, int monArrNum)
{
	...
	case FORM_WHIP: //채찍
		...
		{
		case LEFT:
			if		(renge == 3)EFFECTMANAGER->play("채찍L0", _collisionX-30,_collisionY);
			else if (renge == 1)EFFECTMANAGER->play("채찍L1", _collisionX-30,_collisionY);
			else if (renge == 0)EFFECTMANAGER->play("채찍L2", _collisionX-30,_collisionY);
			else if (renge == 2)EFFECTMANAGER->play("채찍L3", _collisionX-30,_collisionY);
			else if (renge == 4)EFFECTMANAGER->play("채찍L4", _collisionX-30,_collisionY);
			break;													
		case RIGHT:													
			if		(renge == 3)EFFECTMANAGER->play("채찍R0", _collisionX+30,_collisionY);
			...
			else if (renge == 4)EFFECTMANAGER->play("채찍R4", _collisionX+30,_collisionY);
			break;													
		case UP:													
			if		(renge == 3)EFFECTMANAGER->play("채찍U0", _collisionX,_collisionY-30);
			else if (renge == 1)EFFECTMANAGER->play("채찍U1", _collisionX,_collisionY-30);
			else if (renge == 0)EFFECTMANAGER->play("채찍U2", _collisionX,_collisionY-30);
			else if (renge == 2)EFFECTMANAGER->play("채찍U3", _collisionX,_collisionY-30);
