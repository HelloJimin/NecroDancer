...
void player::effectControl(attackForm form, int rengeArrNum, int monArrNum)
{
	...
	case FORM_WHIP: //채찍
		...
		case LEFT:
			...
			break;													
		case RIGHT:													
			if		(renge == 0)EFFECTMANAGER->play("채찍R0", _collisionX+30,_collisionY);
			else if (renge == 1)EFFECTMANAGER->play("채찍R1", _collisionX+30,_collisionY);
			else if (renge == 2)EFFECTMANAGER->play("채찍R2", _collisionX+30,_collisionY);
			else if (renge == 3)EFFECTMANAGER->play("채찍R3", _collisionX+30,_collisionY);
		...
		case UP:													
			...
			break;													
		case DOWN:													
			if		(renge == 0)EFFECTMANAGER->play("채찍D0", _collisionX,_collisionY+30);
			else if (renge == 1)EFFECTMANAGER->play("채찍D1", _collisionX,_collisionY+30);
			else if (renge == 2)EFFECTMANAGER->play("채찍D2", _collisionX,_collisionY+30);
			else if (renge == 3)EFFECTMANAGER->play("채찍D3", _collisionX,_collisionY+30);
